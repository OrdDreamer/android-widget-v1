...
// Lora (serif, display moments) + Karla (humanist sans, everything else) — the design system's
// two-family pairing (see "Photo Widget Design System/readme.md" § Type). Both were shipped to
// this repo as OFL-licensed variable fonts (res/font/lora.ttf, lora_italic.ttf, karla.ttf,
// karla_italic.ttf, sourced from github.com/google/fonts) rather than the design bundle's own
// Google Fonts `@import` (no font files were included in the handoff).
...
val Karla = FontFamily(
    Font(R.font.karla, FontWeight.Normal, variationSettings = weight(400)),
    Font(R.font.karla, FontWeight.Medium, variationSettings = weight(500)),
    Font(R.font.karla, FontWeight.SemiBold, variationSettings = weight(600)),
    Font(R.font.karla, FontWeight.Bold, variationSettings = weight(700)),
    Font(R.font.karla_italic, FontWeight.Normal, FontStyle.Italic, variationSettings = weight(400)),
)
